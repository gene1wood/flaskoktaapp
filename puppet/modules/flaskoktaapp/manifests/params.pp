# # Class: params
#
# This class manages flaskoktaapp parameters
#
# ## Parameters
...
# @param wsgi_filename The filename of the [WSGI] [2] file
# @param domain_name The DNS name of the virtualhosted apache site
# @param app_name The name of the flask application
#
# [1]: http://flask.pocoo.org/docs/quickstart/#sessions "Flask sessions" 
# [2]: http://flask.pocoo.org/docs/0.10/deploying/mod_wsgi/#creating-a-wsgi-file "Flask WSGI file"
#
...
-----END RSA PRIVATE KEY-----'
  ...
  $username = 'flaskoktaappuser'
  $virtualenv_dir = '/opt/flaskoktaapp/venv'
  $wsgi_filename = '/opt/flaskoktaapp/flaskoktaapp.wsgi'
  $app_name = 'flaskoktaapp'
}